...
--       page=200, size=20 → (19+1)*200+1 = 4001   (V3 최대 페이지)
--   → 아무리 깊은 페이지라도 COUNT 는 최대 search_limit 행만 훑는다.
--
-- 파라미터:
--   @board_id     : 대상 게시판 (핫보드 2001001)
--   search_limit  : 위 공식 결과. 아래 예시는 page=200,size=20 → 4001 (LIMIT 리터럴)
--
...
--   * 안쪽 rows 가 search_limit(=4001) 로 상한 → v1/v2-count 의 100만+ 와 대비
