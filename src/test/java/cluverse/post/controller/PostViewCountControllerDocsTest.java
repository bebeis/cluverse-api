...
import cluverse.post.service.PostViewCountService;
...
class PostViewCountControllerDocsTest extends RestDocsSupport {

    private final PostViewCountService postViewCountService = mock(PostViewCountService.class);
    private final ViewCountCookieResolver viewCountCookieResolver = new ViewCountCookieResolver();

    @Override
    protected Object initController() {
        return new PostViewCountController(postViewCountService, viewCountCookieResolver);
    }
    ...
    void 전체_조회수_카운터를_증가시킨다() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/posts/{postId}/view-count", 10L)
                ...
                .andDo(document("posts/increase-view-count",
                        pathParameters(
