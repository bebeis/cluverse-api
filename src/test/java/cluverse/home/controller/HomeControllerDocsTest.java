...
class HomeControllerDocsTest extends RestDocsSupport {

    private final HomeQueryService homeQueryService = mock(HomeQueryService.class);

    @Override
    protected Object initController() {
        return new HomeController(homeQueryService);
    }
    ...
    void 최근_댓글_글_개선_전_조회() throws Exception {
        when(homeQueryService.getRecentCommentedPosts(1L)).thenReturn(recentPosts());
