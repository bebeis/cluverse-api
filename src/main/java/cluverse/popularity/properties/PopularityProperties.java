...
public record PopularityProperties(
        ...
        @DefaultValue("5") @PositiveOrZero int defaultLikeGate,
        @DefaultValue("3") @PositiveOrZero int defaultCommentGate,
        @DefaultValue("3") @PositiveOrZero int scoreLikeWeight,
        @DefaultValue("2") @PositiveOrZero int scoreCommentWeight,
        @DefaultValue("1") @PositiveOrZero int scoreViewWeight,
        ...
        @DefaultValue("1m") @NotNull Duration policyCacheRefreshInterval,
        @DefaultValue("1m") @NotNull Duration v1ScanInterval,
        @DefaultValue("false") boolean baselineScanEnabled,
        @DefaultValue("1000") @Positive int scanChunkSize,
        @DefaultValue("30s") @NotNull Duration candidateRecheckInterval,
        @DefaultValue("500") @Positive int candidateBatchSize,
