...
public class PopularPostControllerV2 {
    ...
    public ApiResponse<PopularPostListResponse> getRecent(
        ...
        return ApiResponse.ok(popularPostQueryService.getRecent(PopularityAlgorithmVersion.V2, size));
    }
    ...
    public ApiResponse<PopularPostListResponse> getHistory(
        ...
        return ApiResponse.ok(popularPostQueryService.getHistory(PopularityAlgorithmVersion.V2, sort, size));
    }
}
