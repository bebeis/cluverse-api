...
public class GroupProcessor {
    ...
    public void removeMember(Long memberId, Long groupId, Long targetMemberId) {
        Group group = groupReader.readActiveOrThrow(groupId);
        validateManager(memberId, group);
        groupWriter.removeMember(group, targetMemberId);
    }

    public GroupDetailResponse transferOwner(Long memberId, Long groupId, GroupOwnerTransferRequest request) {
        Group group = groupReader.readActiveOrThrow(groupId);
