...
import cluverse.comment.service.LocalMapCommentWriteService;
...
public class LocalMapCommentController {

    private final LocalMapCommentWriteService service;
    ...
    public ApiResponse<CommentWithPlaceCreateResponse> create(
            ...
            @RequestBody @Valid CommentWithPlaceCreateRequest request,
