...
public class LocalMapCommentWriteService {

    private final CommentReader commentReader;
    private final PlaceSelectionResolver placeSelectionResolver;
    private final LocalMapCommentWriteProcessor processor;
    private final LocalMapMetricsRecorder metricsRecorder;
    private final PopularityPromotionInvoker popularityPromotionInvoker;

    public Long create(Long memberId, Long postId, CommentWithPlaceCreateRequest request, String clientIp) {
