...
/**
 * V1(naive offset)/V2(deferred join) 목록 조회 요청.
 * V3({@link PostSearchRequest})와 달리 날짜 기반 조회가 없고,
 * 뒷 페이지(offset 40만) 성능 측정을 위해 페이지 상한을 20,000까지 허용한다.
 */
public record PostOffsetSearchRequest(
        ...
        @Max(value = 20_000, message = "페이지는 20000 이하여야 합니다.")
        Integer page,
