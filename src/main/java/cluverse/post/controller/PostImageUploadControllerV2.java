...
public class PostImageUploadControllerV2 {
    ...
    public ApiResponse<PostImageUploadResponse> upload(
        ...
        return ApiResponse.created(service.upload(ImageUploadVersion.V2, benchmarkToken, request));
    }
}
