...
public class PlaceQueryService {
    ...
    public PlaceDetailResponse readDetail(Long placeId) {
        ...
        return PlaceDetailResponse.of(place, placeReader.countRecommendations(placeId));
    }
    ...
    public PlaceContentsResponse readContents(Long placeId, String cursor, Integer requestedSize) {
        ...
        PlaceContentCursorCodec.Cursor decoded = PlaceContentCursorCodec.decode(cursor);
        List<PlaceContentQueryResult> rows = placeReader.readContents(
        ...
        String nextCursor = hasNext && !page.isEmpty() ? PlaceContentCursorCodec.encode(page.getLast()) : null;
